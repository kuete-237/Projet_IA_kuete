...
universites = {
    ...
    "Magistrat": [
        ...
        ("Paris 1 Panthéon-Sorbonne", "https://www.pantheonsorbonne.fr")
    ],
    "Avocat": [
        ("Université de Yaoundé II", "https://www.univ-yaounde2.org"),
        ("Université de Douala", "https://www.univ-douala.cm")
    ...
    "Journaliste international": [
        ("ESJ Lille", "https://esj-lille.fr"),
        ("CFJ Paris", "https://www.cfjparis.com")
    ],
    "Traducteur / Interprète": [
        ("ESIT Paris", "https://esit.univ-paris3.fr"),
