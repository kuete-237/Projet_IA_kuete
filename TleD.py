...
universites = {
    ...
    "Médecin spécialiste": [
        ("Université de Yaoundé I - Faculté de Médecine", "https://www.uy1.uninet.cm"),
    ...
    "Pharmacien": [
        ...
        ("Université de Monastir", "http://www.um.rnu.tn")
    ],
    ...
    "Infirmier diplômé d'État": [
        ...
        ("Croix Rouge", "https://www.ifrc.org")
    ],

    "Infirmier spécialisé": [
        ("Institut Supérieur de Santé", "#"),
        ("WHO Training", "https://www.who.int")
    ],

    "Ingénieur agronome": [
        ("Université de Dschang", "https://www.univ-dschang.org"),
        ("IITA Afrique", "https://www.iita.org")
    ],

    "Vétérinaire": [
        ("Université de Ngaoundéré", "https://www.univ-ndere.cm"),
        ("VetAgro Sup France", "https://www.vetagro-sup.fr")
    ],
